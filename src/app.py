...
activities = {
    ...
    "Soccer Team": {
        "description": "Competitive soccer team practicing fundamentals and playing matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["ryan@mergington.edu", "lisa@mergington.edu"]
    },
    "Basketball Team": {
        "description": "After-school basketball team focusing on skills and inter-school games",
        "schedule": "Tuesdays and Thursdays, 4:30 PM - 6:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu", "nora@mergington.edu"]
    },
    "Art Club": {
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["sara@mergington.edu", "tyler@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Hands-on experiments and competition preparation across science disciplines",
        "schedule": "Mondays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["rya@mergington.edu", "zara@mergington.edu"]
    }
}
